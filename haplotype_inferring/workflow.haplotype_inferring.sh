...
# you can also try to get region on the fly withoud downloading files from the 1kg server
# as a toy dataset, we provide in this folder ld map of archaic SNPs in 500kb around the give aSNP 
...
Rscript script.infer_haplotype_based_on_R2.R ${chr}_$pos.for_r2.tmp.geno.ld $chr $pos # && rm *tmp* # if working, can uncomment this
